...
export const LiWithProgress: styled = styled.li`
  display: flex;
  align-items: center;
  ...
  cursor: pointer;
`;
export const DominanceDiv: styled = styled.div`
...
export const ProgressBar: styled = styled.div`
  ...
  background: #2172e5;
`;
export const DominanceProgressBar: styled = styled.div`
  height: 100%;
  width: ${(props: { percent: { btcDominancePercent: number; }; }) => props.percent.btcDominancePercent}%;
  border-radius: 20px;
...
export const DominanceHoverDiv1 = ({
  ...
  coinNameLong,
  dominance,
}: DominanceHoverDiv1Props): React.JSX.Element => {
  return (
    <HoverDiv1>
      <BulletPoint />
      <p>
...
const HoverDiv2: styled = styled.div`
  align-items: center;
  padding: 10px;
  background: ${(props: { theme: { main: string; }; }) => props.theme.main};
  border-radius: 10px;
...
const ProgressBarHover: styled = styled.div`
  ...
  background: #2172e5;
`;
const DominanceProgressBarHover: styled = styled.div`
  height: 100%;
...
export const DominanceHoverDiv2 = ({
  ...
  dominancePercent,
  text,
}:DominanceHoverDiv2Props): React.JSX.Element => {
  return (
    <HoverDiv2>
...
const BitcoinLogoSubNav: styled = styled.svg`
  width: 20px;
  margin-right: 8px;
`;
const EthereumLogoSubNav: styled = styled.svg`
  width: 16px;
  margin-right: 8px;
`;
export const BitcoinSvgSubNav = (): React.JSX.Element => {
  return (
    <BitcoinLogoSubNav
...
export const EthereumSvgSubNav = (): React.JSX.Element => {
  return (
    <EthereumLogoSubNav
