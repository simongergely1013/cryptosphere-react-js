...
export const getCoinsTableData =
  (currency, page) => async (dispatch, getState) => {
    try {
      const state = getState();
      // let coinsData = state.coinsTable.coinsData;
      ...
      if (!data.length) {
        ...
        // console.log("page", page, "data", data, "coinsdata", coinsData);
